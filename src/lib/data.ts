...
export const rooms: Room[] = [
  ...
  {
    id: 'family',
    slug: 'family-garden-view',
    name: 'Семейный с видом на сад',
    description: 'Большой номер с кроватью размера "king-size" и двухъярусной кроватью, идеально подходит для смей. С видом на наш прекрасный сад и небольшой кухней для вашего удобства.',
    price: 2200,
    capacity: 4,
