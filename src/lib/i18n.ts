...
const resources = {
  ru: {
    translation: {
      ...
      // Hero
      premiumBadge: "Премиум-отель рядом с морем",
      heroTitle1: "Погрузитесь в роскошь",
      heroTitle2: "черноморского побережья",
      heroTitle3: "в Zatoka Resort",
      heroDescription: "Отель премиум-класса. Кристально чистый бассейн, песчаный пляж в 10 минутах ходьбы и безупречный сервис для вашего абсолютного расслабления.",
      firstLine: "Рядом с морем",
      beachDistance: "10 минут до пляжа",
      security: "Конфиденциальность",
      securedArea: "Закрытая охраняемая территория",
      bookStay: "Забронировать отдых",
      learnMore: "Исследовать номера",
      ...
      whyBeachDesc: "Песчаный пляж всего в 10 минутах спокойной ходьбы от отеля — приятная прогулка к морю.",
      ...
      dateAlreadyBooked: "Этот день уже забронирован",
  ...
  uk: {
    translation: {
      ...
      // Hero
      premiumBadge: "Преміум-готель поруч з морем",
      heroTitle1: "Пориньте в розкіш",
      heroTitle2: "чорноморського узбережжя",
      heroTitle3: "в Zatoka Resort",
      heroDescription: "Готель преміум-класу. Кристально чистий басейн, піщаний пляж в 10 хвилинах ходьби та бездоганний сервіс для вашого абсолютного розслаблення.",
      firstLine: "Поруч з морем",
      beachDistance: "10 хвилин до пляжу",
      security: "Конфіденційність",
      securedArea: "Закрита охоронювана територія",
      bookStay: "Забронювати відпочинок",
      learnMore: "Дослідити номери",
      ...
      whyBeachDesc: "Піщаний пляж всього в 10 хвилинах спокійної ходьби від готелю — приємна прогулянка до моря.",
      ...
      dateAlreadyBooked: "Цей день вже заброньовано",
  ...
  en: {
    translation: {
      ...
      // Hero
      premiumBadge: "Premium Seaside Hotel",
      heroTitle1: "Immerse Yourself in",
      heroTitle2: "Seaside Luxury",
      heroTitle3: "at Zatoka Resort",
      heroDescription: "A premium seaside retreat. Crystal-clear pool, sandy beach just a 10-minute walk away, and impeccable service for your ultimate relaxation.",
      firstLine: "Close to the Sea",
      beachDistance: "10-minute walk to beach",
      security: "Privacy",
      securedArea: "Gated private territory",
      ...
      whyBeachDesc: "Sandy beach is just a 10-minute leisurely walk from the hotel — a pleasant stroll to the sea.",
