...
export const resources = {
  ru: {
    translation: {
      ...
      dateAlreadyBooked: "Этот день уже занят, попробуйте другой номер",
      ...
      // Reviews section
      roomReviewsTitle: "Отзывы гостей о номере",
      roomReviewsDesc: "Реальные впечатления посетителей, забронировавших",
      roomReviewsEmpty: "Отзывов пока нет. Будьте первым!",
      roomReviewsWriteTitle: "Оставить отзыв",
      roomReviewsWriteDesc: "Чтобы оставить отзыв о номере, пожалуйста, авторизуйтесь через Google или войдите как администратор.",
      roomReviewsGoogleBtn: "Войти через Google",
      roomReviewsAdminBtn: "Войти как Администратор",
      roomReviewsAdminAuth: "Авторизован как Администратор",
      roomReviewsNameLabel: "Ваше имя",
      roomReviewsRatingLabel: "Ваша оценка",
      roomReviewsCommentLabel: "Комментарий",
      roomReviewsCommentPlaceholder: "Поделитесь вашими впечатлениями об отдыхе...",
      roomReviewsSubmitBtn: "Отправить отзыв",
      roomReviewsSaveBtn: "Сохранить",
      roomReviewsCancelBtn: "Отмена",
      roomReviewsEditInputPlaceholder: "Комментарий",
      roomReviewsNameInputPlaceholder: "Имя",
      roomReviewsLogoutBtn: "Выйти",
      roomReviewsToastAddedTitle: "Отзыв добавлен",
      roomReviewsToastAddedDesc: "Спасибо! Ваш отзыв сохранен в базе данных.",
      roomReviewsToastErrorTitle: "Ошибка",
      roomReviewsToastErrorDesc: "Не удалось отправить отзыв. Попробуйте еще раз.",
      roomReviewsToastEditSuccessTitle: "Отзыв обновлен",
      roomReviewsToastEditSuccessDesc: "Изменения успешно сохранены.",
      roomReviewsToastEditErrorDesc: "Не удалось сохранить изменения.",
      roomReviewsToastEmptyFields: "Поля не могут быть пустыми",
      roomReviewsDeleteTitle: "Удалить отзыв?",
      roomReviewsDeleteDesc: "Вы уверены, что хотите удалить этот отзыв гостя? Это действие безвозвратно удалит отзыв из базы данных.",
      roomReviewsLoadingReviews: "Загрузка отзывов...",
      roomReviewsReviewsCount: "отзывов",
      roomReviewsToastGoogleLoginTitle: "Авторизован через Google",
      roomReviewsToastGoogleLoginDesc: "Добро пожаловать! Теперь вы можете оставить отзыв.",
      roomReviewsToastGoogleLoginErrorTitle: "Ошибка входа",
      roomReviewsToastGoogleLoginErrorDesc: "Не удалось войти через Google. Убедитесь, что настроены переменные окружения в .env.",
      roomReviewsToastGoogleLogoutTitle: "Выход выполнен",
      roomReviewsToastGoogleLogoutDesc: "Вы вышли из учетной записи Google.",
      roomReviewsToastErrorName: "Пожалуйста, введите ваше имя",
      roomReviewsToastErrorComment: "Пожалуйста, напишите комментарий",
      roomReviewsToastDeleteTitle: "Отзыв удален",
      roomReviewsToastDeleteDesc: "Отзыв успешно удален из базы данных.",
      roomReviewsToastDeleteErrorDesc: "Не удалось удалить отзыв."
    },
  },
  uk: {
    translation: {
      ...
      dateAlreadyBooked: "Цей день вже зайнятий, спробуйте інший номер",
      ...
      // Reviews section
      roomReviewsTitle: "Відгуки гостей про номер",
      roomReviewsDesc: "Реальні враження відвідувачів, які забронювали",
      roomReviewsEmpty: "Відгуків поки немає. Будьте першим!",
      roomReviewsWriteTitle: "Залишити відгук",
      roomReviewsWriteDesc: "Щоб залишити відгук про номер, будь ласка, авторизуйтесь через Google або увійдіть як адміністратор.",
      roomReviewsGoogleBtn: "Увійти через Google",
      roomReviewsAdminBtn: "Увійти як Адміністратор",
      roomReviewsAdminAuth: "Авторизовано як Адміністратор",
      roomReviewsNameLabel: "Ваше ім'я",
      roomReviewsRatingLabel: "Ваша оцінка",
      roomReviewsCommentLabel: "Коментар",
      roomReviewsCommentPlaceholder: "Поділіться вашими враженнями про відпочинок...",
      roomReviewsSubmitBtn: "Надіслати відгук",
      roomReviewsSaveBtn: "Зберегти",
      roomReviewsCancelBtn: "Скасувати",
      roomReviewsEditInputPlaceholder: "Коментар",
      roomReviewsNameInputPlaceholder: "Ім'я",
      roomReviewsLogoutBtn: "Вийти",
      roomReviewsToastAddedTitle: "Відгук додано",
      roomReviewsToastAddedDesc: "Дякуємо! Ваш відгук збережено в базі даних.",
      roomReviewsToastErrorTitle: "Помилка",
      roomReviewsToastErrorDesc: "Не вдалося надіслати відгук. Спробуйте ще раз.",
      roomReviewsToastEditSuccessTitle: "Відгук оновлено",
      roomReviewsToastEditSuccessDesc: "Зміни успішно збережено.",
      roomReviewsToastEditErrorDesc: "Не вдалося зберегти зміни.",
      roomReviewsToastEmptyFields: "Поля не можуть бути порожніми",
      roomReviewsDeleteTitle: "Вилучити відгук?",
      roomReviewsDeleteDesc: "Ви впевнені, що хочете видалити цей відгук гостя? Ця дія безповоротно видалить відгук з бази даних.",
      roomReviewsLoadingReviews: "Завантаження відгуків...",
      roomReviewsReviewsCount: "відгуків",
      roomReviewsToastGoogleLoginTitle: "Авторизовано через Google",
      roomReviewsToastGoogleLoginDesc: "Ласкаво просимо! Тепер ви можете залишити відгук.",
      roomReviewsToastGoogleLoginErrorTitle: "Помилка входу",
      roomReviewsToastGoogleLoginErrorDesc: "Не вдалося увійти через Google. Переконайтеся, що налаштовані змінні оточення в .env.",
      roomReviewsToastGoogleLogoutTitle: "Вихід виконано",
      roomReviewsToastGoogleLogoutDesc: "Ви вийшли з облікового запису Google.",
      roomReviewsToastErrorName: "Будь ласка, введіть ваше ім'я",
      roomReviewsToastErrorComment: "Будь ласка, напишіть коментар",
      roomReviewsToastDeleteTitle: "Відгук видалено",
      roomReviewsToastDeleteDesc: "Відгук успішно видалено з бази даних.",
      roomReviewsToastDeleteErrorDesc: "Не вдалося видалити відгук."
    },
  },
  en: {
    translation: {
      ...
      dateAlreadyBooked: "This date is already booked, please try another room",
      ...
      // Reviews section
      roomReviewsTitle: "Guest Reviews of the Room",
      roomReviewsDesc: "Real experiences of visitors who booked",
      roomReviewsEmpty: "No reviews yet. Be the first to leave one!",
      roomReviewsWriteTitle: "Leave a Review",
      roomReviewsWriteDesc: "To leave a review, please sign in with Google or log in as an administrator.",
      roomReviewsGoogleBtn: "Sign in with Google",
      roomReviewsAdminBtn: "Sign in as Administrator",
      roomReviewsAdminAuth: "Authorized as Administrator",
      roomReviewsNameLabel: "Your Name",
      roomReviewsRatingLabel: "Your Rating",
      roomReviewsCommentLabel: "Comment",
      roomReviewsCommentPlaceholder: "Share your experience about the stay...",
      roomReviewsSubmitBtn: "Submit Review",
      roomReviewsSaveBtn: "Save",
      roomReviewsCancelBtn: "Cancel",
      roomReviewsEditInputPlaceholder: "Comment",
      roomReviewsNameInputPlaceholder: "Name",
      roomReviewsLogoutBtn: "Logout",
      roomReviewsToastAddedTitle: "Review Added",
      roomReviewsToastAddedDesc: "Thank you! Your review has been saved.",
      roomReviewsToastErrorTitle: "Error",
      roomReviewsToastErrorDesc: "Failed to submit review. Please try again.",
      roomReviewsToastEditSuccessTitle: "Review Updated",
      roomReviewsToastEditSuccessDesc: "Changes saved successfully.",
      roomReviewsToastEditErrorDesc: "Failed to save changes.",
      roomReviewsToastEmptyFields: "Fields cannot be empty",
      roomReviewsDeleteTitle: "Delete Review?",
      roomReviewsDeleteDesc: "Are you sure you want to delete this guest review? This action will permanently remove it from the database.",
      roomReviewsLoadingReviews: "Loading reviews...",
      roomReviewsReviewsCount: "reviews",
      roomReviewsToastGoogleLoginTitle: "Authorized via Google",
      roomReviewsToastGoogleLoginDesc: "Welcome! Now you can leave a review.",
      roomReviewsToastGoogleLoginErrorTitle: "Login Error",
      roomReviewsToastGoogleLoginErrorDesc: "Failed to sign in with Google. Make sure environmental variables are configured in .env.",
      roomReviewsToastGoogleLogoutTitle: "Logged Out",
      roomReviewsToastGoogleLogoutDesc: "You have signed out of your Google account.",
      roomReviewsToastErrorName: "Please enter your name",
      roomReviewsToastErrorComment: "Please write a comment",
      roomReviewsToastDeleteTitle: "Review Deleted",
      roomReviewsToastDeleteDesc: "Review has been successfully deleted from the database.",
      roomReviewsToastDeleteErrorDesc: "Failed to delete review."
    },
  },
};
