...
const resources = {
  ru: {
    translation: {
      ...
      // Hero
      premiumBadge: "Премиум-отель на первой линии моря",
      heroTitle1: "Погрузитесь в роскошь",
      heroTitle2: "черноморского побережья",
      heroTitle3: "в Zatoka Resort",
      heroDescription: "Отель премиум-класса. Кристально чистый бассейн, песчаный пляж в 10 метрах и безупречный пятизвездочный сервис для вашего абсолютного расслабления.",
      firstLine: "Первая береговая линия",
      beachDistance: "10 метров до пляжа",
  ...
  uk: {
    translation: {
      ...
      // Hero
      premiumBadge: "Преміум-готель на першій лінії моря",
      heroTitle1: "Пориньте в розкіш",
      heroTitle2: "чорноморського узбережжя",
      heroTitle3: "в Zatoka Resort",
      heroDescription: "Готель преміум-класу. Кристально чистий басейн, піщаний пляж за 10 метрів та бездоганний п'ятизірковий сервіс для вашого абсолютного розслаблення.",
      firstLine: "Перша берегова лінія",
      beachDistance: "10 метрів до пляжу",
  ...
  en: {
    translation: {
      ...
      // Hero
      premiumBadge: "Premium Beachfront Hotel",
      heroTitle1: "Immerse Yourself in",
      heroTitle2: "Seaside Luxury",
      heroTitle3: "at Zatoka Resort",
      heroDescription: "A premium beachfront retreat. Crystal-clear pool, sandy beach just 10 meters away, and impeccable five-star service for your ultimate relaxation.",
      firstLine: "First Beachline",
      beachDistance: "10 meters to the beach",
      security: "Privacy",
