...
import { LogOut, Home, Bed, LayoutDashboard, CalendarDays, PhoneCall, BookOpen, MessageSquare, Menu, Tag, Waves, ArrowRightLeft, Clock } from 'lucide-react';
...
const navLinks = [
  ...
  { href: "/admin/logs", label: "Логи", icon: Clock },
