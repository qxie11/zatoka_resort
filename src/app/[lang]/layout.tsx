...
export default async function RootLayout({
  ...
  const faqJsonLd = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": lang === "uk" ? "Які ціни на проживання в Zatoka Resort?" : "Каковы цены на проживание в отеле Zatoka Resort?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": lang === "uk"
            ? `Ціни на проживання варіюються від ${minPrice} грн/добу до ${maxPrice} грн/добу в залежності від обраної категорії номера.`
            : `Цены на проживание варьируются от ${minPrice} грн/сутки до ${maxPrice} грн/сутки в зависимости от выбранной категории номера.`
        }
      },
      {
        "@type": "Question",
        "name": lang === "uk" ? "Чи є мангали та зона BBQ на території отеля?" : "Есть ли мангальная зона и BBQ на территории отеля?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": lang === "uk"
            ? "Так, на території готелю Zatoka Resort для всіх гостей є безкоштовна мангальна зона з грилем, шампурами та альтанками."
            : "Да, на территории отеля Zatoka Resort для всех гостей оборудована бесплатная мангальная зона с грилем, шампурами и уютными беседками."
        }
      },
      {
        "@type": "Question",
        "name": lang === "uk" ? "Чи підходить готель Zatoka Resort для відпочинку з дітьми?" : "Подходит ли отель Zatoka Resort для отдыха с детьми?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": lang === "uk"
            ? "Так, отель повністю орієнтований на сімейний відпочинок: є відкритий басейн, дитячий майданчик та закрита територія."
            : "Да, отель полностью ориентирован на семейный отдых: есть открытый бассейн, детская площадка и безопасная закрытая территория."
        }
      },
      {
        "@type": "Question",
        "name": lang === "uk" ? "Чи є безкоштовна парковка та Wi-Fi?" : "Предоставляется ли бесплатная парковка и Wi-Fi?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": lang === "uk"
            ? "Так, для гостей готелю надається безкоштовна автостоянка та швидкісний Wi-Fi на всій території готелю."
            : "Да, для всех гостей предоставляется бесплатная охраняемая автостоянка и скоростной Wi-Fi на всей территории отеля."
        }
      },
      {
        "@type": "Question",
        "name": lang === "uk" ? "Як забронювати номер без комісії?" : "Как забронировать номер без комиссии?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": lang === "uk"
            ? "Забронювати номер напряму у власників без комісій можна на офіційному сайті https://zatoka-hotel.com або за телефону / Telegram +380669212275. Оплата при заїзді."
            : "Забронировать номер напрямую у владельцев без комиссий можно на официальном сайте https://zatoka-hotel.com или по телефону / Telegram +380669212275. Оплата при заезде."
        }
      }
    ]
  };
